...
export const fixtures: MotorEvoFixture[] = [
  ...
  {
    id: 'f05',
    description: 'Ultramaratona (60km custom), objetivo explícito "abaixo de 7 horas".',
    focus:
      'veryLongDistance força goal_anchored independente de enduranceWords/muchSlowerGoal; tabela de offsets de ultra + capFast em Z4/Z5.',
    input: {
      name: 'Fixture 05',
      age: 38,
      height: 172,
      ...
      daysPerWeek: 5,
      test3kmTime: '13:00',
      objective: 'Quero terminar a ultra com segurança, abaixo de 7 horas',
    },
  },
  {
    id: 'f06',
    description: '5k, objetivo com pace explícito ("pace 4:30").',
    focus:
      'getGoalTargetInfo padrão de pace explícito (source objective_pace); distanceKm < 21 mantém capacity_anchored mesmo com goalPace quase igual ao teste.',
    input: {
      name: 'Fixture 06',
      age: 25,
      height: 180,
      ...
      daysPerWeek: 3,
      test3kmTime: '13:45',
      objective: 'Quero treinar no pace 4:30',
    },
  },
  {
    id: 'f07',
    description: '21k (meia), sem objetivo declarado.',
    focus: 'raceType "meia" sem goalPace → zoneStrategy permanece capacity_anchored (contraste com f03).',
    input: {
      name: 'Fixture 07',
      age: 45,
      height: 168,
