...
import {
  ...
  type CompleteWorkoutFormInput,
} from '@/components/workout/CompleteWorkoutModal';
...
import {
  readTrainingZones,
  splitWorkoutDescription,
} from '@/services/workout/workout-detail.service';
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
          ...
          <View style={styles.header}>
            <Text style={styles.meta}>
              {phaseCap} • S{workout.week_number}
            </Text>
          ...
          {isPending ? (
            ...
            <View style={styles.statusCardWrap}>
              ...
              <View style={{ alignItems: 'center' }}>
                {workout.status === 'completed' ? (
                  <>
                    <Text style={styles.statusLine}>
                      {workout.completed_km ?? workout.planned_km ?? 0} km realizados
                    </Text>
                ...
                {workout.feedback ? (
                  <Text style={[styles.statusLine, { marginTop: spacing.sm }]}>
                    {workout.feedback}
                  </Text>
                ) : null}
              </View>
