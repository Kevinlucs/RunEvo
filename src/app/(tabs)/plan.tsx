...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: colors.textPrimary, fontSize: 22, ...fontWeight('800'),textAlign: 'center', marginBottom: -spacing.xs },
  sectionText: { color: colors.textSecondary, fontSize: 14, ...fontWeight('400'), marginBottom: spacing.xl, lineHeight: 20, textAlign: 'center' },
  badgePill: { alignSelf: 'flex-start', backgroundColor: 'rgba(204,255,0,0.15)', borderRadius: radii.pill, paddingHorizontal: spacing.md, paddingVertical: spacing.xs, marginBottom: spacing.lg, width: '100%', alignItems: 'center' },
